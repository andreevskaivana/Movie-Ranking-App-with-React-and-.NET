...
{
    //this is to service get requests from clients
    //request an item of type 1=>return movies
    //to make our class a controller it has to inherit from controller base class
    //then add api controller attribute
